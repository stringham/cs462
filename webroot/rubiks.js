...
RubiksCube.prototype.render = function(){
	...
	goog.array.forEach(this.points, function(point){
		point.projection();
	});

	goog.array.forEach(this.faces, function(face){
...
RubiksCube.prototype.getState = function(){
	...
	goog.array.forEach(this.faceNames, function(face){
